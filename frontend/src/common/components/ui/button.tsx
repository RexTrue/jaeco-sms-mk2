  ...
  return (
    <button
      className={cn(
        ...
        variant === 'primary' &&
          'border-transparent bg-[linear-gradient(135deg,var(--accent-strong),var(--accent))] text-[#fff8ea] shadow-[0_16px_44px_rgba(197,167,109,0.3)] hover:-translate-y-0.5 hover:brightness-105',
        variant === 'secondary' &&
